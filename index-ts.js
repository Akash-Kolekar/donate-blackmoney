...
function fund() {
    return __awaiter(this, void 0, void 0, function () {
        var ethAmount, account, currentChain, request, hash, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function getBalance() {
    return __awaiter(this, void 0, void 0, function () {
        var account, balanceOfUser, balance;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    balanceOfUser = _a.sent();
                    return [4 /*yield*/, publicClient.getBalance({
                            address: constants_ts_ts_1.contractAddress,
                        })];
                case 3:
                    balance = _a.sent();
                    console.log((0, viem_1.formatEther)(balanceOfUser));
...
function withdraw() {
    return __awaiter(this, void 0, void 0, function () {
        var account, currentChain, request, hash, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
